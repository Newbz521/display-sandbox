...
/** Low extruded prism sitting on the board plane — visuals only. */
function Extrude({
  x,
  y,
  w,
 ...
 *
 * Hit testing uses a single static plate above the 3D props so press/hover
    ...
    <AnimatePresence>
      {visible ? (
        ...
        >
          ...
          >
            <span
              className="pointer-events-none select-none font-semibold uppercase leading-none tracking-[0.12em]"
        ...
        >
          <span
            className="pointer-events-none select-none font-semibold uppercase tracking-[0.22em]"
            style={{
      ...
      {/*
        Static hit plate above the props. Sibling of the animated visuals so
        press/scale never moves the target out from under the cursor (which
        was canceling Framer onTap).
      */}
      <div
        role="button"
        tabIndex={0}
        ...
        style={{
          ...
          pointerEvents: 'auto',
          cursor: 'pointer',
          // Tiny alpha so some browsers still hit-test the face reliably.
